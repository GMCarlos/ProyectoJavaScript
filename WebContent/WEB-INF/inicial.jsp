	...
	<body>
        ...
        <header>
            <div class="contenedor">
                <h1 class="icon-dollar"><a href="ListChollosServlet.do">PIRECIAZOS</a></h1>
                <input type="checkbox" id="menu-bar">
                <label class="icon-menu-1" for="menu-bar"></label>
                <nav class="menu">
                    <a href="IniciarSesion.do">Iniciar Sesion</a>
                </nav>
            ...
            <section id="banner">
                ...
                <div class="contenedor">
                    ...
                    <p>¿Qué tipo de chollo estás buscando?</p>
                </div>
            </section>
			...
			<tbody>
				<c:forEach var="chollo" items="${chollosList}">
					<tr> 
						...
						<td><a href="IniciarSesion.do"><img src="img/Like.PNG" alt="Mano arriba" width="40px"></a></td>
						<td><a href="IniciarSesion.do"><img src="img/Dislike.PNG" alt="Mano abajo" width="40px" ></a></td>
					</tr>	
		    	</c:forEach>
		    	</tbody>	
			</table>	
