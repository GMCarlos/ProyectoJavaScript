...
/**
 * Servlet implementation class BuscarPorLikes
 */
@WebServlet("/BuscarPorLikesDescendente.do")
public class BuscarPorLikesDescendente extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuscarPorLikesDescendente() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//logger.info("Atendiendo GET");  
		  ...
		  List<Chollo> cholloList = cholloDAO.getByLikes();
