...
/**
 * Servlet implementation class MostrarChollosDisponibles
 */
@WebServlet("/MostrarChollosDisponibles.do")
public class MostrarChollosDisponibles extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MostrarChollosDisponibles() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//logger.info("Atendiendo GET");  
		  ...
		  List<Chollo> cholloList = cholloDAO.getChollosDisponibles();
