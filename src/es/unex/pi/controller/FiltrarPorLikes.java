...
/**
 * Servlet implementation class FiltrarPorLikes
 */
@WebServlet("/FiltrarPorLikes.do")
public class FiltrarPorLikes extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FiltrarPorLikes() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//logger.info("Atendiendo GET");  
		  ...
		  if(!request.getParameter("buscarLikes").isEmpty()) {
			  List<Chollo> cholloList = cholloDAO.getFiltradoPorLikes(Integer.parseInt(request.getParameter("buscarLikes")));
...
//				}
			  ...
			  //si le doy a buscar y no he metido
